package our.dxz.trip.servlet.cost_ctrl;
...
import our.dxz.trip.service.cost_ctrl.CostControlService;
import our.dxz.trip.utils.Mog;

public class CostControlServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	CostControlService taService = new CostControlService();

	/**
	 * Constructor of the object.
	 */
	public CostControlServlet() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		// 设置编码
		if ("travelApproveCtl".equals(action)) {
			String result = getTravelAppList(request, response);
			request.setAttribute("result", result);
			request.getRequestDispatcher("cost_ctrl/costControl_approve.jsp")
	...
	public String getTravelAppList(HttpServletRequest request,
	...
	public void updateApproveRf(HttpServletRequest request,
			HttpServletResponse response) {
		...
		String name = request.getParameter("approve_costcontroller");
		String reason = request.getParameter("refuse_reson_costcontroller");
		Mog.d("打回trapp_no:", no);
		...
		approve.setApprove_costcontroller(name);
		approve.setRefuse_reson_costcontroller(reason);
	...
	public void updateApproveDis(HttpServletRequest request,
			HttpServletResponse response) {
		...
		String no = request.getParameter("trapp_no");
		String name = request.getParameter("approve_costcontroller");
		String reason = request.getParameter("return_reason_costcontroller");
		Mog.d("打回trapp_no:", no);
		Mog.d("打回return_reason_depmanager:", reason);
		Mog.d("打回approve_depmanager:", name);
		...
		approve.setTrapp_no(no);
		approve.setApprove_costcontroller(name);
		approve.setReturn_reason_costcontroller(reason);
	...
	public void correntDate(HttpServletRequest request,
		...
		approve.setApprove_date_costcontroller(Timestamp.valueOf(time));
