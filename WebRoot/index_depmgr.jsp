...
<%
	...
	if (cookies != null)
	{
		for (int i = 0; i < cookies.length; i++)
		{
			...
			if(cookies[i].getName().equals("login")  && cookies[i].getValue().equals("1"))
			{
				...
				<div class="easyui-accordion" data-options="fit:true">
					...
					<div data-options="title:'审批出差申请',iconCls:'icon-search'">
						<div>
							...
							<a
								href="javascript:addTabs('审批出差申请','ApproveTravelServlet?action=travelAppApprove')">审批出差申请</a>
						</div>
					</div>
					
					<div data-options="title:'审批借款申请',iconCls:'icon-search'">
						<div>
							<img src="static/img/admin.gif" />
							<a
								href="javascript:addTabs('审批借款申请','ApproveBorrowServlet?action=ApproveBorrow')">审批借款申请</a>
						</div>
					</div>
					
					<div data-options="title:'点评总结报告',iconCls:'icon-search'">
						<div>
							<img src="static/img/admin.gif" />
							<a
								href="javascript:addTabs('点评总结报告','ApproveSumServlet?action=getTravelSum')">点评总结报告</a>
						</div>
					</div>
					
					<div data-options="title:'审批报销申请',iconCls:'icon-search'">
						<div>
							<img src="static/img/admin.gif" />
							<a
								href="javascript:addTabs('审批报销申请','ApproveExpenseServlet?action=getExpenseAppList')">审批报销申请</a>
						</div>
					</div>
