...
<%
	...
	if (cookies != null)
	{
		for (int i = 0; i < cookies.length; i++)
		{
			...
			if(cookies[i].getName().equals("login")  && cookies[i].getValue().equals("4"))
			{
		...
		<div class="easyui-layout" data-options="fit:true">
			...
			<div data-options="region:'west',title:'菜单',split:true"
				...
				<div class="easyui-accordion" data-options="fit:true">
					...
					<div data-options="title:'借款与报销',iconCls:'icon-search'">
						<div>
							<img src="static/img/admin.gif" />
							<a
								href="javascript:addTabs('借款申请','AllBorrowServlet?action=getBorrowAppList')">借款申请</a>
						</div>
						<div>
							<img src="static/img/admin.gif" />
							<a
								href="javascript:addTabs('报销申请','AllExpenseServlet?action=getExpenseAppList')">报销申请</a>
						</div>
					</div>
				</div>
			</div>
