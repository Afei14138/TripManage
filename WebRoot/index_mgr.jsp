...
<%
	...
	if (cookies != null)
	{
		for (int i = 0; i < cookies.length; i++)
		{
			...
			if(cookies[i].getName().equals("login")  && cookies[i].getValue().equals("3"))
			{
...
<html>
  <head>
    <title>My JSP 'index_mgr.jsp' starting page</title>
				...
				<div class="easyui-accordion" data-options="fit:true">
					...
					<div data-options="title:'审批借款申请',iconCls:'icon-search'">
						<div>
							...
							<a
								href="javascript:addTabs('审批借款申请','MApproveBorrowServlet?action=MApproveBorrow')">审批借款申请</a>
						</div>
					</div>
					...
					<div data-options="title:'审批报销申请',iconCls:'icon-search'">
						<div>
							<img src="static/img/admin.gif" />
							<a
								href="javascript:addTabs('审批报销申请','MApproveExpenseServlet?action=getExpenseAppList')">审批报销申请</a>
						</div>
					</div>
